...
const Pagemaker = React.lazy(() => import('./views/Pages/Pagemaker'));
const Pages = React.lazy(() => import('./views/Pages/Pages'));
...
const routes = [
  ...
  { path: '/customer/:id', exact: true, name: 'Customers', component: Customer },
  { path: '/page/create.exe', exact: true, name: 'Pagemaker', component: Pagemaker },
  { path: '/pages.msi', exact: true, name: 'Pages', component: Pages },
];
